    ...
    return (
        <div className="md:h-[50vh] bg-black">
                ...
                <div className="text-white">
                    ...
                    <div className="mt-10">
                        ...
                        <div className="relative mt-4">
                            ...
                            <button className="py-2 absolute right-0 bottom-0 bg-green-300 px-4 rounded-r-full">go</button>
                        </div>
                    </div>
                </div>
            ...
            <div className="border-t-2 border-[#4d4d4d] border-dashed h-[10vh]  flex justify-center items-center">
                    <h1 className="flex items-center gap-1 text-[#4d4d4d]"> <MdCopyright className="mt-[1px]"/>copyright tnc global ltd. </h1>
            </div>
        </div>
    );
};
